...
require_once ASA_LIB_DIR . 'AsaZend/Service/Abstract.php';

/** AsaZend_Rest_Client_Result */
require_once ASA_LIB_DIR . 'AsaZend/Rest/Client/Result.php';

/** AsaZend_Uri */
require_once ASA_LIB_DIR . 'AsaZend/Uri.php';
...
class AsaZend_Rest_Client extends AsaZend_Service_Abstract
{
    ...
    final private function _prepareRest($path)
    {
        ...
        if (!$this->_uri instanceof AsaZend_Uri_Http) {
            require_once ASA_LIB_DIR . 'AsaZend/Rest/Client/Exception.php';
