...
class WP_Widget_AmazonSimpleAdmin extends WP_Widget {
    ...
    function widget($args, $instance) 
    {
        ...
        $class_inner              = isset($instance['asa_widget_class_inner']) ? strip_tags($instance['asa_widget_class_inner']) : '';
...
?>
        ...
        <input min="0" max="999" id="<?php echo $this->get_field_id('asa_collection_items'); ?>" name="<?php echo $this->get_field_name('asa_collection_items'); ?>" type="number" value="<?php echo esc_attr($asa_items); ?>" /></p>
